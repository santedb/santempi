...
Source: {#iCDRBase}\bin\Release\icudt52.dll; DestDir: {app}; Components: db\fbsql
Source: {#iCDRBase}\bin\Release\icuin52.dll; DestDir: {app}; Components: db\fbsql
...
Source: {#iCDRBase}\SanteDB\Data\SDB_BASE.FDB; DestDir: {app}; Components: db\fbsql demo; Flags: confirmoverwrite
Source: {#iCDRBase}\SanteDB\Data\SDB_AUDIT.FDB; DestDir: {app}; Components: db\fbsql demo; Flags: confirmoverwrite
...
Source: {#iCDRBase}\bin\Release\RestSrvr.dll; DestDir: {app}; Components: core server
...
Source: {#iCDRBase}\bin\Release\ZXing.*.dll; DestDir: {app}; Components: server core
Source: {#iCDRBase}\bin\Release\SixLabors.*.dll; DestDir: {app}; Components: server core
...
; ATNA
Source: {#iCDRBase}\bin\Release\AtnaApi.dll; DestDir: {app}; Components: interop\atna
...
; HL7v2
Source: {#iCDRBase}\bin\Release\NHapi.Base.dll; DestDir: {app}; Components: interop\hl7
Source: {#iCDRBase}\bin\Release\NHapi.Model.V231.dll; DestDir: {app}; Components: interop\hl7
Source: {#iCDRBase}\bin\Release\NHapi.Model.V25.dll; DestDir: {app}; Components: interop\hl7
Source: {#iCDRBase}\santedb-hl7\SanteDB.Messaging.HL7\Data\*.dataset; DestDir: {app}\data; Components: interop\hl7
Source: {#iCDRBase}\bin\Release\SanteDB.Messaging.HL7.dll; DestDir: {app}; Components: interop\hl7
...
Source: {#iCDRBase}\bin\Release\SanteDB.Rest.BIS.dll; DestDir: {app}; Components: reporting\bis
...
; Atna Interop
Source: {#iCDRBase}\bin\Release\SanteDB.Messaging.Atna.dll; DestDir: {app}; Components: interop\atna

; GS1
Source: {#iCDRBase}\bin\Release\SanteDB.Messaging.GS1.dll; DestDir: {app}; Components: interop\gs1
