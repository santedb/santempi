...
mkdir dist
pakman --compile --optimize --source=..\santedb-server\SanteDB.Messaging.HL7\applet --output=.\bin\org.santedb.hl7.pak --keyFile=..\keys\community.santesuite.net.pfx --keyPassword=..\keys\community.santesuite.net.pass --embedcert --install --publish --publish-server=https://packages.santesuite.net
